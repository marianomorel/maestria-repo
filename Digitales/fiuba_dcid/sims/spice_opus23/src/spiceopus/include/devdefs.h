...
// 1.	Pointer DEVarea added into SPICEdev structure for calculating device's area.
// Author: Janez Puhan
//////////
...
typedef struct SPICEdev {
	...
	/* noise routine */
	int (*DEVarea)(GENmodel*, CKTcircuit*, double*);	// Return device's area.
#else /* stdc */
	...
	int (*DEVarea)();	// Return device's area.
#endif /* stdc */
