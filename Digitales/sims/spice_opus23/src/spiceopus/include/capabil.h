...
// 1.	Turned on DELETES so devices and models can be deleted.
// Author: Arpad Buermen
//////////
// 2.	If one wanted to compile the original code with predictor corrector
//		algorithm then the PREDICTOR macro should be added here. If the truncation
//		error is also to be calculated by predictor corrector algorithm then
//		NEWTRUNC macro should be added here. Now both macros are obsolete and
//		replaced by nopredictor and newtrunc options.
// Author: Janez Puhan
//////////
...
#  define SIGNAL_FUNCTION SIGNAL_TYPE (*)(int)
#endif
